...
export function updateFileInputText() {
...
export async function uploadFiles(loadJobs) {
  const fileInput = document.getElementById('fileInput');
...
export async function uploadText(loadJobs) {
...
export function setupGlobalDropZone(switchTab) {
